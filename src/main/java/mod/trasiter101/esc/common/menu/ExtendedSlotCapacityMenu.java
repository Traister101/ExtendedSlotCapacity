 ...
 * We provide {@link ExtendedSlotCapacitySynchronizer} for synchronizing. Call {@link #setSynchronizer(ContainerSynchronizer)} after
 * {@link ServerPlayer#initMenu(AbstractContainerMenu)} by hooking {@link PlayerContainerEvent.Open}
 */
